...
const NavBar = () => {
  ...
  const navClass = `py-1 px-6 rounded-xl hover:text-primarylight transform transition duration-300 my-2 hover:translate-x-2 text-sm font-medium`;
        ...
        >
          <div className={`flex justify-center items-center`}>
            ...
            <p
              ...
              className="px-2 py-1 bg-neutral-700/40 backdrop-blur text-neutral-400 rounded-4xl ml-3 font-light tracking-wider text-center hidden sm:block">v1.2.0-alpha</p>
          </div>
