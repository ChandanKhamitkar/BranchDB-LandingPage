            ...
            <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-neutral-100 font-medium mx-auto w-fit mb-6 text-center">
             ...
             <a
                ...
                >
                    ...
                    <span className="inline-flex h-full w-full items-center justify-center rounded-xl bg-black px-6 py-4 text-lg font-medium text-neutral-200 backdrop-blur-xl">
                        Star Us On GitHub
                        <IoLogoGithub className="text-neutral-100 size-9 ml-4" />
                    </span>
                </a>
        </div>
    );
