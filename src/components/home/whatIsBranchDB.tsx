export default function WhatIsBranchDB() {
    return (
        <div className="flex flex-col justify-center items-center py-20 bg-black relative px-4 md:px-6">
            ...
            <p className="text-base sm:text-xl md:text-2xl text-neutral-500 max-w-5xl mx-auto text-center leading-7 md:leading-10 mt-6">BranchDB is an open-source, in-memory key-value database written in <span className="px-2 py-1 rounded-xl bg-neutral-700/70 text-primary text-sm sm:text-xl">C++</span> — built from scratch for performance and developer control. It supports expiration, disk persistence, multi-threaded architecture, compact logging and multi-user architecture.</p>
